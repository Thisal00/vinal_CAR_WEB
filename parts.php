    ...
    if (mysqli_num_rows($result) === 0) {
      ...
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<div class='part-card animate__animated animate__fadeInUp'>
          ...
          <div class='part-desc'>".nl2br(htmlspecialchars($row['description']))."</div>
          <div class='action-btns'>
            <a href='view_part.php?id=$part_id' class='view-btn'>View</a>
            <a href='mailto:admin@example.com?subject=Buy Request for $part_name&body=Hello, I want to buy this part.' class='email-btn'>Email</a>
            <a href='https://wa.me/94712345678?text=Hello,%20I%20want%20to%20buy%20$part_name' target='_blank' class='whatsapp-btn'>WhatsApp</a>
          </div>
        </div>";
      }
    }
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 mb-4">
        ...
        <a href="about.php" class="footer-link">About